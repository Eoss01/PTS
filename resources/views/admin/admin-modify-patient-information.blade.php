        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="title">Modify Patient Information</h5>
                </div>
                <div class="card-body">
                    <form action="/admin-modify-patient-information-update/{{ $patients->patient_id  }}" method="POST">
                        {{ csrf_field() }}
                        {{ method_field('PUT') }}
                        <div class="row">
                            <div class="col-md-1 ">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <a href="/admin.admin-manage-patient" class="btn btn-danger">Back</a>
                                </div>
                            </div>
                        </div>
                    </form>
