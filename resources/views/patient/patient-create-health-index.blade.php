        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="title">Add Health Index</h5>
                </div>
                <div class="card-body">
                    <form action="/create-health-index" method="POST">
                        {{ csrf_field() }}
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="blood_sugar_after_eat" class="form-control" maxlength="3"
                                        ...
                                        value="{{ old('blood_sugar_after_eat') }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="HbA1c" class="form-control" maxlength="3"
                                        placeholder="Hemoglobin A1C" value="{{ old('HbA1c') }}">
                                </div>
                            </div>
                        </div>
