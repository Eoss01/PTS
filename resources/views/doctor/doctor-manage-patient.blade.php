        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="/doctor.doctor-create-user" class="btn btn-primary pull-right">Add</a>
                </div>
                <div class="card-body">
                          ...
                          @endif
                            ...
                            <tbody style="text-align:center;overflow-x:auto;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="/doctor-view-patient-information/{{ $patient->patient_id }}" class="btn btn-primary">View</a>  
                                        <a href="/doctor-modify-patient-information/{{ $patient->patient_id }}" class="btn btn-sucess">Edit</a>  
...
<script>
  $(document).ready( function () {
      ...
      $('#dataTable').on('click', '.deletebtn', function () {
        ...
        $('#delete_model_form').attr('action', '/doctor_delete_patient_information/'+data[0]);
