    ...
    <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="carousel-item active"
                ...
                <div class="container">
                    <h2>Welcome to use <span>Patient Tracking System</span></h2>
...
<main id="main">
    ...
    <section id="services" class="services services">
        <div class="container" data-aos="fade-up">
            ...
            <div class="section-title">
                <h2>Services</h2>
                <p>The following services are tailor-made for patients with chronic diseases and their doctor in charge.</p>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 icon-box" data-aos="zoom-in" data-aos-delay="200">
                    ...
                    <p class="description">Patient can view the advice that provided by their doctor in charge in this system.</p>
                </div>
                <div class="col-lg-4 col-md-6 icon-box" data-aos="zoom-in" data-aos-delay="300">
                    <div class="icon"><i class="icofont-heartbeat"></i></div>
                    <h4 class="title"><a href="">View date of follow-up visit</a></h4>
                    <p class="description">Patient can view the date of follow-up visit that provided by their doctor in charge in this system.</p>
                </div>
                <div class="col-lg-4 col-md-6 icon-box" data-aos="zoom-in" data-aos-delay="100">
                    <div class="icon"><i class="icofont-heart-beat"></i></div>
                    <h4 class="title"><a href="">View medical equipment supplier</a></h4>
                    <p class="description">Patient can view the medical equipment supplier information in this system.</p>
                </div>
                <div class="col-lg-4 col-md-6 icon-box" data-aos="zoom-in" data-aos-delay="200">
                    <div class="icon"><i class="icofont-drug"></i></div>
                    <h4 class="title"><a href="">Provide advice</a></h4>
                    <p class="description">Doctor can provide their advice to their patient in charge in this system.</p>
                </div>
                <div class="col-lg-4 col-md-6 icon-box" data-aos="zoom-in" data-aos-delay="300">
                    <div class="icon"><i class="icofont-heartbeat"></i></div>
                    <h4 class="title"><a href="">Provide the date of follow-up visit</a></h4>
                    <p class="description">Doctor can provide the date of follow-up visit to their patient in charge in this system.</p>
                </div>
            </div>
            ...
            <form action="/supplier-create" method="POST" role="form" class="php-email-form" data-aos="fade-up"
                ...
                <div class="form-group">
                    @error('supplier_address')
                        <label class="form-group" style="color: #e83f3f;">{{ $message }}</label>
                    @enderror
                    <textarea rows="4" cols="80" class="form-control" placeholder="Please provide your address"
                ...
                <div class="text-center"><button type="submit">Make an Supplier Request</button></div>
            </form>
    ...
    <section id="supplier" class="testimonials">
        <div class="container" data-aos="fade-up">
            ...
            <div class="section-title">
                <h2>Supplier</h2>
                <p>The following medical equipment supplier information is the supplier that has been certified and accepted by the administrator. After 5 working days if your information has not been registered on this system, please make sure that your personal supplier information is correct and resubmit your request again in this system.
</p>
            </div>
    ...
    <section id="contact" class="contact">
        <div class="container">
            ...
            <div class="section-title">
                <h2>Contact</h2>
                <p>We would be delighted to respond to your enquiries, please feel free to drop us a line using the phone or email us.</p>
            </div>
        ...
        <div class="container">
            <iframe
                src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d13415.21768298415!2d103.62997507510143!3d1.5448783791358776!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1smedical%20equipment%20supplier!5e0!3m2!1szh-CN!2smy!4v1597584527329!5m2!1szh-CN!2smy"
